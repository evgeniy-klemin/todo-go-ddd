...
- [ ] No race conditions in the logic
...
- [ ] Domain model is clear and well-defined
- [ ] Repository and service layers are well-separated
- [ ] Ports and adapters are well-separated
...
- Minor clean architecture or DDD violations
